...
const Footer = () => {
  return (
    <footer className="bg-dark-text pt-16 pb-6 mt-12 border-t  bg-sky-950 shadow-lg border-dark-secondary">
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        > DOC.<span className="text-blue-400">AI</span>
                ...
                <p className="text-subtle-text mt-2 ml-14 text-sm max-w-sm">
        ...
        <div className="flex flex-col sm:flex-row justify-between items-center">
            ...
            <p className="text-subtle-text text-sm mb-4 sm:mb-0">
