...
const Navbar = () => {
  return (
    ...
    <ul className="flex justify-between">
        ...
        <li>
           <Link href={"/login"}>
            <button href="contact.html" className="bg-emerald-500 hover:bg-emerald-600 text-white font-semibold py-2 px-4 rounded-lg shadow-md transition duration-300 ease-in-out transform hover:scale-105">
              Login
            </button></Link>
        </li>
    </ul>
