...
//   // If NextAuth is still checking the session, show a simple placeholder or nothing
//   if (status === "loading") {
//     return <nav className="..."> {/* Your Navbar structure without the session buttons */} </nav>;
//   }
//   // if(session) {
//   //   return <>
...
//               className="bg-gray-500 text-white px-3 py-2 rounded-lg font-bold text-sm hover:bg-gray-600"
//             >
//               Cancel
//             </button>
//           </div>
...
//   <Link href="/register">
//     <button className="bg-blue-600 hover:bg-blue-500 text-white font-semibold py-2 px-5 rounded-lg shadow-md transition duration-300 ease-in-out transform hover:scale-105 active:scale-95">
//       Sign Up
//     </button>
//   </Link>
